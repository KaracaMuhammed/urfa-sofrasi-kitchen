...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CpZEid1K.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DD625rHn.js").then((n) => n.r),
    import("./start-BnxuJZXq.js"),
...
var ROUTER_BASEPATH = "urfa-sofrasi-kitchen";
var SERVER_FN_BASE = "/urfa-sofrasi-kitchen/_serverFn/";
