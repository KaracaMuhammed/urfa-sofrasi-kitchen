  ...
  head: () => ({
    meta: [
      { title: "Menukaart — Urfa Sofrası" },
      {
        name: "description",
        content:
          "Pides, lahmacun, schotels, kapsalon, Turkse desserts en dranken bij Urfa Sofrası.",
      },
        ...
        <section className="border-t border-border bg-secondary/40 px-5 py-16 sm:px-8 lg:py-20">
          <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[1fr_1fr] lg:items-center">
            ...
            <div className="overflow-hidden rounded-panel border border-border shadow-panel">
              <img src={menuAsset.url} alt="Menukaart Urfa Sofrası" loading="lazy" className="w-full" />
            </div>
          </div>
        </section>
      </main>
