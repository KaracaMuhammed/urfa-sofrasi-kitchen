          ...
          <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[1fr_1fr] lg:items-center">
            <div>
              ...
              <h1 className="mt-4 font-display text-5xl leading-tight sm:text-6xl">
                Een stukje <em className="not-italic text-ember">Urfa</em>, op een buurttafel gezet.
              </h1>
              <p className="mt-6 text-lg leading-8 text-muted-foreground">
                Şanlıurfa, in zuidoostelijk Anatolië, is een stad van brood, vuur en langzame
                gastvrijheid. Dat idee namen we mee naar huis: een kleine keuken met een hete oven,
                een lange tafel, en gerechten zoals we ze van kinds af aan kennen.
              </p>
              <p className="mt-4 italic text-muted-foreground">
                "Sofra" betekent letterlijk <span className="text-ink">eettafel</span> — de plek
                waar alles samenkomt.
              </p>
            </div>
            <div className="overflow-hidden rounded-panel shadow-panel">
              <img src={images.interior} alt="Binnen bij Urfa Sofrası" className="w-full" />
            </div>
          </div>
        </section>
        ...
        <section className="border-y border-border bg-secondary/40 px-5 py-16 sm:px-8 lg:py-20">
          <div className="mx-auto grid max-w-6xl gap-10 md:grid-cols-3">
            {[
              ...
              <div
                key={b.k}
                className="rounded-panel border border-border bg-card p-7 shadow-panel-soft"
              >
        ...
        <section className="px-5 py-16 sm:px-8 lg:py-24">
          <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            <div className="overflow-hidden rounded-panel shadow-panel">
              <img
                src={images.exterior}
                alt="Voorgevel van Urfa Sofrası"
                loading="lazy"
                className="w-full"
              />
            </div>
            <div>
              ...
              <p className="mt-6 text-lg leading-8 text-muted-foreground">
                Of het nu een snelle lahmacun is tussen de middag of de hele tafel op zaterdagavond
                — je bent welkom bij Urfa Sofrası.
              </p>
              <Link
                to="/contact"
